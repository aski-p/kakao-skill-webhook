...
try {
    ...
    console.log('🎬 KOFIC 한국 영화 데이터 수집 결과 요약\n');
    console.log(`📅 수집 일시: ${new Date(data.collection_date).toLocaleString('ko-KR')}`);
    console.log(`📊 총 수집 영화: ${data.total_movies}개\n`);
    
    console.log('📽️ 수집된 영화 목록:');
